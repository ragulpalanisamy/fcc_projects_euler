...
export default function Pandigital_number() {
    const codesnippet =`function pandigitalMultiples() {
        const nDigit = 9;
    ...
    const codesnippet1 = `function pandigitalMultiples() {
        const nDigits = 9;
    ...
    const codesnippet2 =`function isPandigital(str) {
